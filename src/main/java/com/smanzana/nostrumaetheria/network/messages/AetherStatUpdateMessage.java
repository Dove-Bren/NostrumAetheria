 ...
 *
 */
public class AetherStatUpdateMessage implements IMessage {

	public static class Handler implements IMessageHandler<AetherStatUpdateMessage, IMessage> {

		@Override
		public IMessage onMessage(AetherStatUpdateMessage message, MessageContext ctx) {
	...
	public AetherStatUpdateMessage() {
		tag = new NBTTagCompound();
	}
	
	public AetherStatUpdateMessage(World world, BlockPos pos, int aether) {
		tag = new NBTTagCompound();
	...
	public AetherStatUpdateMessage(AetherTileEntity te) {
